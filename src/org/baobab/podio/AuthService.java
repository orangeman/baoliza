...
public class AuthService extends Service {
    ...
    public static final String TAG = "PodioAuth";
    public static final String ACCOUNT_TYPE = "com.podio.user";
    public static final String AUTHTOKEN_TYPE = "com.podio.username_password";
     ...
     * authenticating accounts in com.podio domain. The
    ...
    class Authenticator extends AbstractAccountAuthenticator {
        ...
        public Bundle addAccount(AccountAuthenticatorResponse resp,
            ...
            final Intent intent = new Intent(
                    AuthService.this, AuthActivity.class);
            intent.putExtra(
                    AccountManager.KEY_ACCOUNT_AUTHENTICATOR_RESPONSE, resp);
        ...
        public Bundle getAuthToken(AccountAuthenticatorResponse response,
            ...
            final AccountManager am = AccountManager.get(AuthService.this);
            final String authToken = am.getPassword(account);
            if (authToken != null) {
                Log.v(TAG, "authToken available " + authToken);
                final Bundle result = new Bundle();
            ...
            // If we get here, then we have no auth token yet - so we
            // need to re-prompt for user credentials. We do that by creating
